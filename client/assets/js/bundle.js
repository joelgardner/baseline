...
/***/ function(module, exports, __webpack_require__) {
	...
	var _playbackApp = __webpack_require__(196);

	var _playbackApp2 = _interopRequireDefault(_playbackApp);
	...
	var store = (0, _redux.createStore)(_playbackApp2.default, (0, _redux.applyMiddleware)(_reduxThunk2.default));
	...
	store.dispatch((0, _actions.whoami)());
...
/***/ function(module, exports, __webpack_require__) {
	...
	//
	var playbackApp = (0, _redux.combineReducers)({
		route: route,
		apiActivity: apiActivity,
		user: user
	});

	exports.default = playbackApp;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.WHOAMI_RESPONSE = exports.API_ERROR = exports.API_RESPONSE = exports.API_REQUEST = exports.ROUTE_CHANGE = undefined;
	...
	function reqApi(route) {
		return { type: API_REQUEST, route: route };
	}

	var API_RESPONSE = exports.API_RESPONSE = 'API_RESPONSE';
	function recApi(route, payload) {
		return { type: API_RESPONSE, route: route, payload: payload };
	}

	var API_ERROR = exports.API_ERROR = 'API_ERROR';
	function errorApi(route, error) {
		return { type: API_ERROR, route: route, error: error };
	}
	...
	/**
	  * Use hashRoute(route : String) to navigate.  
	  * It sets the hash and dispatches a routeChange event which reducers.playbackApp.route handles. 
	  */
	...
	var apiBaseUrl = '/api';
	function apiAction(route) {
		return function (dispatch) {
			// signal that we're starting an API call
			dispatch(reqApi(route));

			// send request
			return (0, _isomorphicFetch2.default)('$apiBaseUrlasdf$route').then(function (json) {
				// signal that we've received the response
				dispatch(recApi(route, json));
			}, function (err) {
				// signal any errors
	...
	function whoami() {
		...
		return function (dispatch) {
			dispatch(reqApi(route));
			return (0, _isomorphicFetch2.default)(route).then(function (user) {
				// if no valid user in session, redirect to /login
				if (!user || !user.id) return dispatch(hashRoute('/login'));
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"button",
							{ type: "button", className: "btn btn-secondary active btn-sm" },
							"Log in"
						),
						_react2.default.createElement(
							"button",
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement("input", { type: "text", id: "email", className: "form-control", placeholder: "Username" })
						),
						_react2.default.createElement(
							"div",
							{ className: "input-group" },
							...
							_react2.default.createElement("input", { type: "password", id: "password", className: "form-control", placeholder: "Password" })
						),
						_react2.default.createElement(
							"button",
