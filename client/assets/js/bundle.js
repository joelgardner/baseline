...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baselineApp = __webpack_require__(192);

	var _baselineApp2 = _interopRequireDefault(_baselineApp);
	...
	// build our store
	var store = (0, _redux.createStore)(_baselineApp2.default, (0, _redux.applyMiddleware)(_reduxThunk2.default));
	...
	store.dispatch((0, _actions.initSession)());

	// handler for hash changes
	// it defaults to "/login" if no hash
	var hashDidChange = function hashDidChange() {
	  return store.dispatch((0, _actions.routeChange)(document.location.hash.substring(1) || "/login"));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	**/
	...
	function apiActivity() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? initialApiActivityState : arguments[0];
		var action = arguments[1];
	...
	**/
	...
	function user() {
		...
		switch (action.type) {
			case _actions.WHOAMI_RESPONSE:
				return action.user;
			case _actions.WHOAMI_REQUEST:
				return state;
			default:
				return state;
		}
	...
	**/
	...
	var baselineApp = (0, _redux.combineReducers)({
		route: route,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.API_SIGNUP_RESPONSE = exports.API_SIGNUP_REQUEST = exports.API_LOCALAUTH_RESPONSE = exports.API_LOCALAUTH_REQUEST = exports.WHOAMI_RESPONSE = exports.API_ERROR = exports.API_RESPONSE = exports.API_REQUEST = exports.ROUTE_CHANGE = undefined;
	exports.routeChange = routeChange;
	exports.reqApi = reqApi;
	exports.recApi = recApi;
	exports.errorApi = errorApi;
	exports.handleWhoami = handleWhoami;
	exports.requestLocalAuth = requestLocalAuth;
	exports.responseLocalAuth = responseLocalAuth;
	exports.attemptLocalAuth = attemptLocalAuth;
	exports.requestSignup = requestSignup;
	exports.responseSignup = responseSignup;
	exports.signUp = signUp;
	exports.setHashTo = setHashTo;
	...
	var API_LOCALAUTH_REQUEST = exports.API_LOCALAUTH_REQUEST = 'API_LOCALAUTH_REQUEST';
	function requestLocalAuth(email, password) {
		return { type: API_LOCALAUTH_REQUEST, email: email, password: password };
	}

	/// (error : Object, user : Object) : Object
	var API_LOCALAUTH_RESPONSE = exports.API_LOCALAUTH_RESPONSE = 'API_LOCALAUTH_RESPONSE';
	function responseLocalAuth(error, user, token) {
		return { type: API_LOCALAUTH_RESPONSE, error: error, user: user, token: token };
	}

	/// thunk
	/// (email : String, password : String) : Func
	function attemptLocalAuth(email, password) {
		var route = '/auth/login';
		return function (dispatch) {
			dispatch(reqApi(route));
			dispatch(requestLocalAuth(email, password));
			return _http2.default.postJson(route, { email: email, password: password }).then(function (res) {
				if (res.token) {
	...
	var API_SIGNUP_REQUEST = exports.API_SIGNUP_REQUEST = 'API_SIGNUP_REQUEST';
	function requestSignup(email, password, companyName) {
		return { type: API_SIGNUP_REQUEST, email: email, password: password, company: companyName };
	}

	/// (error : Object, user : Object) : Object
	var API_SIGNUP_RESPONSE = exports.API_SIGNUP_RESPONSE = 'API_SIGNUP_RESPONSE';
	function responseSignup(error, user) {
		return { type: API_SIGNUP_RESPONSE, error: error, user: user };
	}

	/// thunk
	/// (email : String, password : String, companyName : String) : Func
	function signUp(email, password, companyName) {
		var route = '/auth/signup';
		return function (dispatch) {
			dispatch(reqApi(route));
			dispatch(requestSignup(email, password, companyName));
			return _http2.default.postJson(route, { email: email, password: password, companyName: companyName }).then(function (res) {
	...
	function whoami(token) {
		...
		return function (dispatch) {
			dispatch(reqApi(route));
			return _http2.default.get(route, token).then(function (res) {
				var user = res.user;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavigationContainer = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavigationContainer = (0, _reactRedux.connect)(mapStateToProps)(_Navigation2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoginContainer = __webpack_require__(201);

	var _LoginContainer2 = _interopRequireDefault(_LoginContainer);

	var _SignupContainer = __webpack_require__(203);
	...
	var routes = {
		'/login': _LoginContainer2.default,
		'/signup': _SignupContainer2.default
	};

	var getViewForRoute = function getViewForRoute(route) {

		// TODO: normalize the route to pass parameters

		return routes[route] || _Error2.default;
	};
	...
	var MainContainer = (0, _reactRedux.connect)(mapStateToProps)(_Main2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    onLoginClick: function onLoginClick(email, password) {
	      dispatch((0, _actions.attemptLocalAuth)(email, password));
	    }
	  };
	};
		...
		_createClass(Login, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement("div", { className: "col-sm-3 col-md-4" }),
					_react2.default.createElement(
						"div",
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								"div",
								{ className: "btn-group signup-group", role: "group" },
								_react2.default.createElement(
									"a",
									{ className: "btn btn-secondary active btn-sm", href: "#/login" },
									"Log in"
								),
								_react2.default.createElement(
									"a",
									{ className: "btn btn-secondary btn-sm", href: "#/signup" },
									"Sign up"
								)
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								"div",
								{ className: "card card-block login-card" },
								_react2.default.createElement(
									"h4",
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											"i",
											{ className: "material-icons md-22" },
											"account_box"
										)
									),
									_react2.default.createElement("input", { type: "text", id: "email", onChange: function onChange(e) {
											return _this2.updateState(e.target.id, e.target.value);
								...
								_react2.default.createElement(
									...
									{ type: "button", className: "btn btn-primary btn-block", onClick: function onClick() {
											return _this2.handleLoginAttempt();
										} },
									"Log  in"
								)
							)
			...
			key: "updateState",
			value: function updateState(propName, value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Signup = __webpack_require__(204);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    onSignupClick: function onSignupClick(email, password, companyName) {
	      dispatch((0, _actions.signUp)(email, password, companyName));
	    }
	  };
	};
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									"a",
									{ className: "btn btn-secondary btn-sm", href: "#/login" },
									"Log in"
								),
								_react2.default.createElement(
									"a",
									{ className: "btn btn-secondary btn-sm active", href: "#/signup" },
									"Sign up"
								)
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement("input", { type: "text", id: "companyName", onChange: function onChange(e) {
											return _this2.updateState(e.target.id, e.target.value);
								...
								_react2.default.createElement(
									...
									_react2.default.createElement("input", { type: "password", id: "password2", onChange: function onChange(e) {
											return _this2.updateState(e.target.id, e.target.value);
